    ...
    <head>
       ...
       body{background-color:lightgrey;}*/
            ...
            <div>
                ...
                Rating(out of 5) : <input type="range" min ="1" max="5 "name="rating">
                any Commands : <textarea rows="3" cols="20" name="commands">
            ...
            <%
                ...
                String query ="select * from empdetails where cname='"+cname+"'";
